...
//  Cookcademy
//
//  Created by Hamza Khan on 2024-03-22.
//
...
class RecipeData: ObservableObject {
    ...
    func saveRecipes() {
        do {
            ...
            try encodedData.write(to: recipesFilesURL)
        }
        catch {
    ...
    func loadRecipes() {
        guard let data = try? Data(contentsOf: recipesFilesURL) else { return }
        do {
    ...
    private var recipesFilesURL: URL {
        do {
